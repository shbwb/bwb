...
# Usage
```html
<link href="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.1.4.x/css/style.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.1.4.x/js/plugins.js"></script>
```
