...
# Usage
```html
<link href="https://cdn.jsdelivr.net/gh/shbwb/bwb.js@v.1.4.1/css/style.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/gh/shbwb/bwb.js@v.1.4.1/js/plugins.js"></script>
```
