...
# Usage
```html
<link href="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.1.0/css/style.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.1.0/js/plugins.js"></script>
```
