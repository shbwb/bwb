...
# Usage
```html
<link href="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.3.3/css/style.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.3.3/js/plugins.js"></script>
```
