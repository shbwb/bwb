...
# Usage
```html
<link href="https://cdn.jsdelivr.net/gh/crqblog/bwb.js@v.1.4.2/css/style.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/gh/crqblog/bwb.js@v.1.4.2/js/plugins.js"></script>
```
