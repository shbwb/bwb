...
# Usage
```html
<link href="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.1.z/css/style.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/gh/shbwb/bwb@v.1.z/js/plugins.js"></script>
```
